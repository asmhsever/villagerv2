  ...
  Future<void> _loadAvailableHouses() async {
    ...
    try {
      ...
      final available = houses
          .where((h) => !usedHouseIds.contains(h.houseId))
          .toList();
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'ข้อมูลคณะกรรมการได้รับการอัปเดตเรียบร้อยแล้ว',
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'รหัส: ${widget.committee.committeeId ?? 'ไม่ระบุ'}',
                                    style: TextStyle(
                                      fontSize: 14,
                      ...
                      _buildReadOnlyField(
                        ...
                        value:
                            widget.committee.committeeId?.toString() ??
                            'ไม่ระบุ',
                        icon: Icons.badge,
                      ),
                      const SizedBox(height: 16),
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<HouseModel>(
              ...
              hint: Row(
                children: [
                  Icon(Icons.home, color: ThemeColors.warmStone, size: 20),
                  const SizedBox(width: 12),
                  Text(
                    'เลือกบ้าน...',
                    style: TextStyle(
              ...
              icon: Icon(Icons.arrow_drop_down, color: ThemeColors.earthClay),
              isExpanded: true,
                ...
                return DropdownMenuItem<HouseModel>(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'บ้านเลขที่: ${house.houseId} (${house.houseNumber ?? 'ไม่ระบุ'})',
                          style: TextStyle(
                            fontSize: 16,
                            color: ThemeColors.earthClay,
                          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'เลือกบ้าน: ${_selectedHouse!.houseNumber ?? 'ไม่ระบุหมายเลข'} (ID: ${_selectedHouse!.houseId})',
