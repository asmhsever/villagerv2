...
class HouseManagePage extends StatefulWidget {
  final int villageId;
  const HouseManagePage({super.key, required this.villageId});

  @override
  State<HouseManagePage> createState() => _HouseManagePageState();
}

class _HouseManagePageState extends State<HouseManagePage> {
          ...
          IconButton(
            ...
            onPressed: () async {
              final result = await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const HouseCreatePage(),
                ),
              );
      ...
      body: _loading
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            subtitle: Text('เจ้าของ: ${house.owner ?? "-"}\nเบอร์: ${house.phone ?? "-"}'),
            onTap: () async {
