...
class _BillPageState extends State<BillPage> {
  ...
  Future<void> _loadLawAndBills() async {
    ...
    if (user is LawModel) {
      ...
      setState(() {
        print(user.villageId);
        _bills = BillDomain.getAllInVillage(
          villageId: user.villageId,
        ); // ✅ Assign to _bills
      });
    } else {
      setState(() {
        _bills = Future.value([]); // ✅ Also wrap in setState
      });
    }
  }
            ...
            children: [
              ...
              pw.TableHelper.fromTextArray(
                ...
                data: bills.map((bill) {
                  ...
                  final status = bill.paidStatus == 1
                      ? 'ชำระแล้ว'
                      : 'ยังไม่ชำระ';
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              title: Text(
                                'บ้านเลขที่ ${bill.houseId} - ${bill.amount} บาท',
                              ),
                              subtitle: Text(
