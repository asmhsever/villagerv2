...
class _BillFormPageState extends State<BillFormPage> {
  ...
  Future<void> _fetchHouses() async {
    ...
    final response = await HouseDomain.getAllInVillage(
      villageId: law.villageId,
    );

    setState(() {
      _houses = response.map((house) => house.toJson()).toList();
    });
  }
  ...
  Future<void> _submit() async {
    ...
    if (isEdit) {
      ...
      await BillDomain.create(bill: bill);
    }
